...
export default function LoginForm() {
   ...
   return (
      <Grid container direction={"column"} spacing={2} justifyContent={"center"} alignItems={"center"} paddingRight={3} padding={5}>
         ...
         <Grid height={10}/>
         <Grid item>
            <Typography variant="body2"><Link href="/register" underline="hover">Đăng ký</Link> hoặc <Link href="/forgot-password" underline="hover">quên mật khẩu</Link></Typography>
         </Grid>
      </Grid>
    )
 }
