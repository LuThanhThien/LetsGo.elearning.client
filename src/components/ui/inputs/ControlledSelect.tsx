...
import { getEnumKey, getEnumValue } from "@/lib/utils";
...
const ControlledSelect = ({ options = [], noOptionsText, control, defaultValue, name, fullWidth, value, onChange, children, ...props } : ControlledSelectProps) => {
...
const ControlledSelectEnum = ({ enumObj, entryProps = { fieldValue: "label", itemValue: "value" }, noOptionsText, control, defaultValue, name, fullWidth, value, onChange, children, ...props } : ControlledSelectEnumProps) => {
