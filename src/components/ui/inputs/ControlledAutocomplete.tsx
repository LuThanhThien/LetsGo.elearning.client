...
const ControlledAutocomplete = ({ options = [], optionKey, renderInput, getOptionLabel, noOptionsText, control, defaultValue, name, renderOption, disablePortal, ...props } : ControlledAutocompleteProps) => {
    return (
      <Controller
        render={({ field }) => (
          <Autocomplete
