...
import { PRICE_INFO_BASIC1, PRICE_INFO_FREE1, PRICE_INFO_SPECIALIZE1 } from "../@share/lib/image";
import { PriceInfo, PriceLevel } from "../@share/index.models";
...
export const Content : {[key: string]: {[key: string]: ContentValue}} = {
    ...
    "Hỗ trợ": {
       ...
       "Liên hệ:": {href: "", child: ["Email: " + Contact.email, "Đường dây nóng: " + Contact.phone]},
    },
 }
